            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner" style="transform: translateY(0px); opacity: 1;">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a class="active" href="#">Add Ticket</a>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div class="col-md-14">
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <form method="post" id="add-ticket" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" required="required" class="form-control" name="member_price">
                      </div>
					  <div class="form-group">
                        <label>Guest's Price</label>
                        <input type="text" required="required" class="form-control" name="guest_price">
                      </div>
                      <div class="form-group">
                        <label>Description For Member</label>
                        <textarea name="member_desc" class="form-control" id="shorteditor"></textarea>
                      </div>
                      <div class="form-group">
                        <label>Description For Guest</label>
                        <textarea name="guest_desc" class="form-control" id="editor"></textarea>
                      </div>
					  <br>
					  <div class="form-group">
...
var validator = $("#add-ticket").validate({
	event:'blur',
	errorClass: 'error',
	rules: {
     event_id: "required",
