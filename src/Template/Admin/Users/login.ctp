<div class="login-wrapper " id="login-page" >
      ...
      <div class="bg-pic">
        ...
        <div class="bg-caption pull-bottom sm-pull-bottom text-white p-l-20 m-b-20">
          ...
          <h5><a class="register-here" href="register.html">Register Here</a></h5>
        </div>
      ...
      <div class="login-container bg-white">
        ...
        <!-- <img src="assets/img/logo-mi.png" alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" width="78" height="22"> -->
          ...
          <!-- START Login Form -->
          <form id="form-login" class="p-t-15" role="form" action="<?=HTTP_ROOT?>admin/users/login" method="post">
            <!-- START Form Control-->
    ...
    <div class="overlay hide" data-pages="search">
      ...
      <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
          <!-- BEGIN Overlay Logo !-->
          <img class="overlay-brand" src="<?=HTTP_ROOT?>img/admin/assets/img/logo.png" alt="logo" data-src="<?=HTTP_ROOT?>img/admin/assets/img/logo.png" data-src-retina="<?=HTTP_ROOT?>img/admin/assets/img/logo_2x.png" width="78" height="22">
          <!-- END Overlay Logo !-->
          <!-- BEGIN Overlay Close !-->
              ...
              <div class="col-md-6">
                ...
                <div class="">
                  ...
                  <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                    <div>
                      <img width="50" height="50" src="<?=HTTP_ROOT?>img/admin/assets/img/profiles/avatar.jpg" data-src="<?=HTTP_ROOT?>img/admin/assets/img/profiles/avatar.jpg" data-src-retina="<?=HTTP_ROOT?>img/admin/assets/img/profiles/avatar2x.jpg" alt="">
                    </div>
                  </div>
