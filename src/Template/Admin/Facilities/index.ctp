            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner" style="transform: translateY(0px); opacity: 1;">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a class="active" href="#">Facilities</a>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading"><?= $this->Flash->render() ?>
                <div class="row">
					...
					<form id="showPages" method="post" action="<?=HTTP_ROOT?>admin/facilities/index<?=$action?>" >
                    ...
                    <div class="col-sm-7" style="margin-top:0px;">
                        <div class="collection-search">
                            ...
                            <div class="input-group ">
								<form method="post" action="<?=HTTP_ROOT?>admin/facilities/index?limit=<?=$limit?>">
								...
								<select class="form-control input-sm page-limit inner-search" aria-controls="basic-usage" name="searchby" style="width:140px;margin-right:10px" id="searchtype">
									  <option value="fc_name" <?php  if($searchby=='fc_name'){?>selected="selected"<?php }?>>Facility Title</option>
                  ...
                  <a class="" href="<?=HTTP_ROOT?>admin/facilities/index"><span class="bold btn btn-primary m-l-10">Reset</span></a>
								</form>
                            </div>
                        </div>
                    </div>
					<div class="btn-group pull-right m-b-10" style="margin-top:20px;">
                     <a href="<?=HTTP_ROOT?>admin/facilities/addfacilities" class="btn btn-primary btn-cons m-b-10"><i class="pg-form"></i> <span class="bold">Add Facility</span>
                    </a>
                </div>
                 </div>
              ...
              <div class="panel-body">
				...
				<form method="post" id="mainform" action="<?= HTTP_ROOT?>admin/facilities/delete">
                  <table class="table table-hover" id="basicTable">
                    <thead>
                      <tr>
                        ...
                        <th style="width:15%"><?= $this->Paginator->sort('fc_name', 'Facility Title');?> </th>
					...
					<?php 
					 ...
					 ?>
                      <tr>
                        ...
                        <td class="v-align-middle">
                          <p><?=$this->Mystring->turncate($value->short_desc)?></p>
                        </td>
                        
                        <td class="v-align-middle">
						  <a href="<?=HTTP_ROOT?>admin/facilities/editfacilities/<?= $value->id?>" title="Edit Facility">
							<span class="glyphicon glyphicon-pencil"></span>
						  </a>
                          <a href="<?=HTTP_ROOT?>admin/facilities/delete/<?= base64_encode($value->id)?>" title="Delete Facility" onclick="if(!confirm('Do you want to delete this record?')){return false;}">
