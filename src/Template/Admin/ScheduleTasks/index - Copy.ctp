            ...
            <div class="panel panel-transparent">
              <div class="panel-heading"><?= $this->Flash->render() ?>
                <div class="row">
					...
					<form id="showPages" method="post" action="<?=HTTP_ROOT?>admin/ScheduleTasks/index<?=$action?>" >
                    ...
                    <div class="col-sm-7" style="margin-top:0px;">
                        <div class="collection-search">
                            ...
                            <div class="input-group ">
								<form method="post" action="<?=HTTP_ROOT?>admin/ScheduleTasks/index?limit=<?=$limit?>">
					...
					<div class="btn-group pull-right m-b-10" style="margin-top:20px;">
                     <a href="<?=HTTP_ROOT?>admin/ScheduleTasks/addtask" class="btn btn-primary btn-cons m-b-10"><i class="pg-form"></i> <span class="bold">Add Schedule Task</span>
                    </a>
                </div>
                 </div>
					...
					<?php 
					 ...
					 ?>
                      <tr>
                        ...
                        <td class="v-align-middle">
						  <a href="<?=HTTP_ROOT?>admin/ScheduleTasks/edittask/<?= base64_encode($value->id)?>" title="Edit Schedules">
