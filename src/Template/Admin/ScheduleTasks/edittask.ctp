            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner" style="transform: translateY(0px); opacity: 1;">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a class="active" href="#">Edit Schedule Task</a>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div class="col-md-14">
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    ...
                    <input type="hidden" name="id" value="<?=$sch_task->id?>">  
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="schedule_id" id="schedule_list">
                            ...
                            <option value="<?php echo $schedule->id?>" <?php if($sch_task->schedule_id == $schedule->id){?>selected="selected"<?php } ?> ><?php echo $schedule->sch_name;?></option>
                            <?php }?>
                        </select>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="task_description" class="form-control" id="shorteditor"><?= $sch_task->task_description?></textarea>
                      </div>
...
window.onload = function()
   ...
   function getSchedule(val) {
        ...
        success: function(schedule){
            ...
            $.each(JSON.parse(schedules), function(index, schedule) {
                options += '<option value="' + schedule.id + '">' + schedule.sch_name + '</option>';
            });
