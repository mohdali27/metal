              ...
              <div class="modal-content-wrapper">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="post" action="<?=HTTP_ROOT?>admin/ScheduleTasks/addtask">
                      <div class="">
                        ...
                        <select class="form-control" name="speaker_id">
                            ...
                            <option value="1">SPEker</option>
                        </select>
                       </div>
						<div class="form-group">
                          <label>Time</label>
                          <input type="text" class="form-control" name="task_time">
                        </div>
						<div class="form-group">
  ...
  $('#mytask').click(function() {
	...
	$('.edit-task').click(function(event) {
        ...
        success: function(data) {
			...
			$('#speaker_id').val(data[0].speaker_id);
